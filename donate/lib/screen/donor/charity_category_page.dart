...
class _CharityCategoryPageState extends State<CharityCategoryPage> {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => Donate(
                            ...
                            events[index].goal,updateGoal,index)));
              },
              child: Container(
            ...
            child: ListTile(
              ...
              trailing: Column(
                ...
                children: [
                  Icon(
                    Icons.star_border,
                    color: indList[index].favorite ? Colors.amber : Colors.grey,
                  ),
                  Text(
                    'Make Favorite',
              ...
              onTap: () {
                setFavoriteIndividual(indList[index], indIdList[index]);
              },
            ),
          );
        },
  ...
  /** Set charity item to favorite
   *
   */
  setFavoriteItem(CharityEvent ce, String uid) async {
  ...
  setFavoriteIndividual(Beneficiary out, String uid) async {
