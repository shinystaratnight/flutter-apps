...
import 'package:fluttertest/screen/user/userHome.dart';
import 'package:provider/provider.dart';
import 'package:provider/src/provider.dart';

import 'package:fluttertest/screen/donor/donor_user_bloc.dart';
...
/**
 * This class manages drawer menu
 * Menu items are: home, my favorite, edit profile, my donations, settings
 */
...
class DrawerMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    context,
    MaterialPageRoute(
    builder: (context) => OrganizationEvents()),
    );
    onResult(result);
    ...
    nextScreen(context, OrganizationBeneficiaries());
    }
    else {
